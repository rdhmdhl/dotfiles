...
require('lazy').setup({
        ...
        callback = function(event)
          ...
          if client and client.supports_method(vim.lsp.protocol.Methods.textDocument_inlayHint) then
            map('<leader>th', function()
              ...
              vim.lsp.inlay_hint(bufner, not enabled)
  ...
  { -- Highlight, edit, and navigate code
    ...
    config = function(_, opts)
      ...
      -- Register zmodel to reuse Prisma syntax highlighting
      vim.treesitter.language.register('prisma', 'zmodel')
    end,
  },
...
-- load custome lsp (mason lsp setup)
require 'custom.lsp.mason-lspconfig'
